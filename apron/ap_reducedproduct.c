		       ...
		       )
{
  ...
  for (i=0; i<intern->size; i++){
	...
	free(man,a->p[i]);
      ...
      void* (*bottom)(ap_manager_t*, size_t, size_t) = man->funptr[AP_FUNID_BOTTOM];
			      ...
			      char** name_of_dim)
{
  ...
  for (i=0;i<intern->size;i++){
    ap_manager_t* man = intern->tmanagers[i];
    void (*ptr)(FILE* stream, ap_manager_t*, void*, void*) = man->funptr[AP_FUNID_FPRINT];
				  ...
				  char** name_of_dim)
{
  ...
  for (i=0;i<intern->size;i++){
    ap_manager_t* man = intern->tmanagers[i];
    void (*ptr)(FILE* stream, ap_manager_t*, void*, void*, void*) = man->funptr[AP_FUNID_FPRINTDIFF];
