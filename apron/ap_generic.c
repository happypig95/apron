			     ...
			     bool quasilinearize)
{
  ...
  bool (*sat_lincons)(ap_manager_t*, void*, void*) = man->funptr[AP_FUNID_SAT_LINCONS];
  bool exact;
...
{
  bool (*is_bottom)(ap_manager_t*, void*) = man->funptr[AP_FUNID_IS_BOTTOM];
  ap_interval_t* (*bound_linexpr)(ap_manager_t*, void*, void*) = man->funptr[AP_FUNID_BOUND_LINEXPR];
  bool exact;
				      ...
				      void* dest)
{
  bool (*is_bottom)(ap_manager_t*,void*) = man->funptr[AP_FUNID_IS_BOTTOM];
  void* (*copy)(ap_manager_t*,void*) = man->funptr[AP_FUNID_COPY];
  void* (*add_dimensions)(ap_manager_t*,bool,void*,void*,bool) = man->funptr[AP_FUNID_ADD_DIMENSIONS];
  void* (*permute_dimensions)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_PERMUTE_DIMENSIONS];
  void* (*remove_dimensions)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_REMOVE_DIMENSIONS];
  void* (*meet_lincons_array)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_MEET_LINCONS_ARRAY];
				    ...
				    void* dest)
{
  ...
  void* (*permute_dimensions)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_PERMUTE_DIMENSIONS];
  void* (*remove_dimensions)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_REMOVE_DIMENSIONS];
  void* (*meet_tcons_array)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_MEET_TCONS_ARRAY];
  void* (*meet)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_MEET];
  void (*ap_free)(ap_manager_t*,void*) = man->funptr[AP_FUNID_FREE];
  ap_dimension_t (*dimension)(ap_manager_t*,void*) = man->funptr[AP_FUNID_DIMENSION];
  size_t i;
