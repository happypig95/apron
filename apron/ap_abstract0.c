			 ...
			 char** name_of_dim)
{
  if (ap_abstract0_checkman1(AP_FUNID_FPRINT,man,a)){
    void (*ptr)(FILE*,ap_manager_t*,void*,void*) = man->funptr[AP_FUNID_FPRINT];
			     ...
			     char** name_of_dim)
{
  if (ap_abstract0_checkman2(AP_FUNID_FPRINTDIFF,man,a,b) &&
    ...
    void (*ptr)(FILE*,ap_manager_t*,void*,void*,void*) = man->funptr[AP_FUNID_FPRINTDIFF];
...
{
  void* (*ptr)(ap_manager_t*,void*,void*) = man->funptr[AP_FUNID_DESERIALIZE_RAW];
...
ap_abstract0_t* ap_abstract0_of_box(ap_manager_t* man,
  ...
  void* (*ptr)(ap_manager_t*,size_t,size_t,void*) = man->funptr[AP_FUNID_OF_BOX];
...
bool ap_abstract0_sat_lincons(ap_manager_t* man, ap_abstract0_t* a, ap_lincons0_t* lincons)
{
  if (ap_abstract0_checkman1(AP_FUNID_SAT_LINCONS,man,a) &&
    ...
    bool (*ptr)(ap_manager_t*,void*,void*) = man->funptr[AP_FUNID_SAT_LINCONS];
...
bool ap_abstract0_sat_tcons(ap_manager_t* man, ap_abstract0_t* a, ap_tcons0_t* tcons)
{
  if (ap_abstract0_checkman1(AP_FUNID_SAT_TCONS,man,a) &&
    ...
    bool (*ptr)(ap_manager_t*,void*,void*) = man->funptr[AP_FUNID_SAT_TCONS];
			       ...
			       ap_dim_t dim, ap_interval_t* interval)
{
  if (ap_abstract0_checkman1(AP_FUNID_SAT_INTERVAL,man,a) &&
    ...
    bool (*ptr)(ap_manager_t*,void*,ap_dim_t,void*) = man->funptr[AP_FUNID_SAT_INTERVAL];
					  ...
					  ap_abstract0_t* a, ap_linexpr0_t* expr)
{
  if (ap_abstract0_checkman1(AP_FUNID_BOUND_LINEXPR,man,a) &&
    ...
    ap_interval_t* (*ptr)(ap_manager_t*,void*,void*) = man->funptr[AP_FUNID_BOUND_LINEXPR];
					...
					ap_abstract0_t* a, ap_texpr0_t* expr)
{
  if (ap_abstract0_checkman1(AP_FUNID_BOUND_TEXPR,man,a) &&
    ...
    ap_interval_t* (*ptr)(ap_manager_t*,void*,void*) = man->funptr[AP_FUNID_BOUND_TEXPR];
    return ptr(man,a->value,expr);
  }
  else {
    ap_interval_t* itv = ap_interval_alloc();
						...
						ap_lincons0_array_t* array)
{
  ...
  if (ap_abstract0_checkman1(AP_FUNID_MEET_LINCONS_ARRAY,man,a) &&
    ...
    void* (*ptr)(ap_manager_t*,void*, void*, void*) = man->funptr[AP_FUNID_MEET_LINCONS_ARRAY];
					      ...
					      ap_tcons0_array_t* array)
{
  ...
  if (ap_abstract0_checkman1(AP_FUNID_MEET_TCONS_ARRAY,man,a) &&
    ...
    void* (*ptr)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_MEET_TCONS_ARRAY];
    void* value = ptr(man,destructive,a->value,array);
    return ap_abstract0_cons2(man,destructive,a,value);
  }
  else {
					   ...
					   ap_generator0_array_t* array)
{
  ...
  if (ap_abstract0_checkman1(AP_FUNID_ADD_RAY_ARRAY,man,a) &&
    ...
    void* (*ptr)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_ADD_RAY_ARRAY];
    void* value = ptr(man,destructive,a->value,array);
    return ap_abstract0_cons2(man,destructive,a,value);
  }
  else {
						  ...
						  ap_abstract0_t* dest)
{
  if (size==0){
	...
	ap_abstract0_check_linexpr_array(funid,man,dimension,texpr,size) ){
      void* (*ptr)(ap_manager_t*,bool,void*,void*,void*,size_t,void*) = man->funptr[funid];
						...
						ap_abstract0_t* dest)
{
  if (size==0){
	...
	ap_abstract0_check_texpr_array(funid,man,dimension,texpr,size) ){
      void* (*ptr)(ap_manager_t*,bool,void*,ap_dim_t,void*,size_t,void*) = man->funptr[funid];
      void* value = ptr(man,destructive,a->value,tdim,texpr,size,dest ? dest->value : NULL);
      return ap_abstract0_cons2(man,destructive,a,value);
    }
    else {
					  ...
					  bool project)
{
  if (size==0){
	...
	ap_abstract0_check_dim_array(AP_FUNID_FORGET_ARRAY,man,dimension,tdim,size)){
      void* (*ptr)(ap_manager_t*,bool,void*,void*,size_t,bool) = man->funptr[AP_FUNID_FORGET_ARRAY];
					    ...
					    bool project)
{
  if (dimchange->intdim+dimchange->realdim==0){
	...
	ap_abstract0_check_ap_dimchange_add(AP_FUNID_ADD_DIMENSIONS,man,dimension,dimchange)){
      void* (*ptr)(ap_manager_t*,bool,void*,void*,bool) = man->funptr[AP_FUNID_ADD_DIMENSIONS];
					       ...
					       ap_dimchange_t* dimchange)
{
  if (dimchange->intdim+dimchange->realdim==0){
	...
	ap_abstract0_check_ap_dimchange_remove(AP_FUNID_REMOVE_DIMENSIONS,man,dimension,dimchange)){
      void* (*ptr)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_REMOVE_DIMENSIONS];
						...
						ap_dimperm_t* perm)
{
  ...
  if (ap_abstract0_checkman1(AP_FUNID_PERMUTE_DIMENSIONS,man,a) &&
    ...
    void* (*ptr)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_PERMUTE_DIMENSIONS];
				  ...
				  size_t size)
{
  ...
  if (ap_abstract0_checkman1(AP_FUNID_FOLD,man,a) &&
	...
	return ap_abstract0_cons(man,ptr(man,a->value));
      ...
      void* (*ptr)(ap_manager_t*,bool,void*,void*,size_t) = man->funptr[AP_FUNID_FOLD];
						...
						ap_lincons0_array_t* array)
{
  ...
  bool (*ptr2)(ap_manager_t*,void*,void*);
  void* value;
  size_t i,j,size;
  ap_lincons0_t tmp;
  ...
  if (ap_abstract0_checkman2(AP_FUNID_WIDENING,man,a1,a2) &&
    ...
    if (i>0){
      array->size = i;
      void* (*ptr)(ap_manager_t*,bool,void*,void*) = man->funptr[AP_FUNID_MEET_LINCONS_ARRAY];
